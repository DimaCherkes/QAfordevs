package com.dimacherkes.qafordevs.repository;
...
public class DeveloperRepositoryTests {
    ...
    public void givenDeveloperObject_whenSave_thenDeveloperIsCreated() {
        // given
        DeveloperEntity developerToSave = DataUtils.getJohnDoePersisted();
    ...
    public void givenDeveloperCreated_whenGetById_thenDeveloperIsReturned() {
        ...
        assertThat(obtainedDeveloper).isEqualTo(developerToSave);
    }
    ...
    public void givenThreeDevelopersAreStored_whenFindAll_thenAllDevelopersAreReturned() {
        ...
        DeveloperEntity mikeSmithTransient = DataUtils.getMikeSmithTransient();
        DeveloperEntity frankJonesTransient = DataUtils.getFrankJonesTransient();

        developerRepository.saveAll(List.of(johnDoeTransient, mikeSmithTransient, frankJonesTransient));
